...
function add_fields() {
    ...
    divtest.innerHTML = '<div class="col-lg-12 text-center"><div class="service-box mt-5 mx-auto"><div class="row" style="width: 800px;"><h5 class="mb-3" style="padding-left: 30px;padding-top: 5px;padding-right: 32px;">Pickup Location:</h4><input type = "text" style="width: 330px;" name = "location2" id = "location2" placeholder = "Room 1202 in CMU, Qatar Foundation"></div></div></div>';
